...
!***********************************************************************
!Renamed and generation of gaussian random variable added.
!Removed statement functions TSHFT.
!Modified to produce uniform random in (0;1]

 module MerTwist
! Default seed
    integer(4), parameter :: defaultsd = 4357
! Period parameters
    integer(4), parameter :: N = 624, N1 = N + 1

! the array for the state vector
    integer(4), save, dimension(0:N-1) :: mt
    integer(4), save                   :: mti = N1
...
! Period parameters
    integer(4), parameter :: M = 397, MATA  = -1727483681
!                                    constant vector a
    integer(4), parameter :: LMASK =  2147483647
!                                    least significant r bits
    integer(4), parameter :: UMASK = -LMASK - 1
!                                    most significant w-r bits
! Tempering parameters
    integer(4), parameter :: TMASKB= -1658038656, TMASKC= -272236544
...
!                              a default initial seed is used
    ...
    !endif
    grnd = 0.5d0 - dble(y)/2.0d0**32

    return
  end function grnd
  
  function ggrnd() Result(r2)
    Double precision :: r2
  ...
  subroutine ggrnd2(res1, res2)
    Double precision, intent(out) :: res1, res2
